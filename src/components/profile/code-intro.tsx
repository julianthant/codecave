...
export function CodeIntro({ profile, userSettings, isOwnProfile = false }: CodeIntroProps) {
  ...
  role: "${userSettings?.experienceLevel === 'senior' ? 'Senior Developer' : 
         userSettings?.experienceLevel === 'mid' ? 'Mid-level Developer' : 
         userSettings?.experienceLevel === 'junior' ? 'Junior Developer' : 
         userSettings?.experienceLevel === 'lead' ? 'Lead Developer' : 'Developer'}",
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-lg font-semibold text-gray-900">Developer Profile</h2>
            <span className="text-sm text-gray-500 font-mono">bio.js</span>
          </div>
        ...
        <div className={`p-6 ${themeClasses} transition-colors duration-200`}>
          <pre className={`${textClasses} font-mono text-sm leading-relaxed overflow-x-auto`}>
            <code className="language-javascript">
              ...
              <span className="text-gray-500">:</span>{' '}
              <span className="text-orange-600">&quot;{profile.displayName || profile.username}&quot;</span>
              <span className="text-gray-500">,</span>
              {'\n'}
              <span className="text-green-600">  username</span>
              <span className="text-gray-500">:</span>{' '}
              <span className="text-orange-600">&quot;@{profile.username}&quot;</span>
              <span className="text-gray-500">,</span>
              {'\n'}
              <span className="text-green-600">  role</span>
              <span className="text-gray-500">:</span>{' '}
              <span className="text-orange-600">&quot;{
                userSettings?.experienceLevel === 'senior' ? 'Senior Developer' : 
                userSettings?.experienceLevel === 'mid' ? 'Mid-level Developer' : 
                userSettings?.experienceLevel === 'junior' ? 'Junior Developer' : 
                userSettings?.experienceLevel === 'lead' ? 'Lead Developer' : 'Developer'
              }&quot;</span>
              ...
              <span className="text-gray-500">:</span>{' '}
              <span className="text-yellow-600">[</span>
              {(userSettings?.languages || ['JavaScript', 'TypeScript']).map((lang, index) => (
                <span key={lang}>
                  <span className="text-orange-600">&quot;{lang}&quot;</span>
                  {index < (userSettings?.languages?.length || 2) - 1 && <span className="text-gray-500">, </span>}
                </span>
              ))}
              <span className="text-yellow-600">]</span>
              <span className="text-gray-500">,</span>
              ...
              <span className="text-gray-500">:</span>{' '}
              <span className="text-yellow-600">[</span>
              {(userSettings?.skills?.slice(0, 6) || ['React', 'Node.js']).map((skill, index) => (
                <span key={skill}>
                  <span className="text-orange-600">&quot;{skill}&quot;</span>
                  {index < (userSettings?.skills?.slice(0, 6)?.length || 2) - 1 && <span className="text-gray-500">, </span>}
                </span>
              ))}
              <span className="text-yellow-600">]</span>
              <span className="text-gray-500">,</span>
              ...
              <span className="text-gray-500">:</span>{' '}
              <span className="text-yellow-600">[</span>
              <span className="text-orange-600">&quot;{userSettings?.skills?.[0] || 'React'}&quot;</span>
              <span className="text-gray-500">, </span>
              <span className="text-orange-600">&quot;{userSettings?.skills?.[1] || 'TypeScript'}&quot;</span>
              <span className="text-gray-500">, </span>
              ...
              <span className="text-gray-500">:</span>{' '}
              <span className="text-orange-600">&quot;I love solving complex problems! 🚀&quot;</span>
              <span className="text-gray-500">,</span>
              {'\n'}
              <span className="text-green-600">  funFact</span>
              <span className="text-gray-500">:</span>{' '}
              <span className="text-orange-600">&quot;I debug with console.log and I&apos;m not ashamed 😄&quot;</span>
              <span className="text-gray-500">,</span>
              {'\n'}
              <span className="text-green-600">  availableForCollab</span>
              <span className="text-gray-500">:</span>{' '}
              <span className="text-blue-600">{userSettings?.availableForCollab ? 'true' : 'false'}</span>
              <span className="text-gray-500">,</span>
              {'\n'}
              ...
              <span className="text-gray-500">:</span>{' '}
              <span className="text-orange-600">&quot;{profile.githubUsername || 'Not set'}&quot;</span>
              <span className="text-gray-500">,</span>
              {'\n'}
              <span className="text-green-600">    twitter</span>
              <span className="text-gray-500">:</span>{' '}
              <span className="text-orange-600">&quot;{profile.twitterUsername || 'Not set'}&quot;</span>
              <span className="text-gray-500">,</span>
              {'\n'}
              <span className="text-green-600">    linkedin</span>
              <span className="text-gray-500">:</span>{' '}
              <span className="text-orange-600">&quot;{profile.linkedinUrl ? 'Available' : 'Not set'}&quot;</span>
              {'\n'}
              <span className="text-yellow-600">{'  }'}</span>
              {'\n'}
              <span className="text-yellow-600">{'}'}</span>
              <span className="text-gray-500">;</span>
              {'\n\n'}
              <span className="text-gray-400">{/* Let's build something amazing together! 🔥 */}</span>
              {'\n'}
              <span className="text-blue-600">console</span>
              <span className="text-gray-500">.</span>
              <span className="text-yellow-600">log</span>
              <span className="text-gray-500">(</span>
              <span className="text-orange-600">`Hello! I&apos;m ${'${developer.name}'} 👋`</span>
              <span className="text-gray-500">);</span>
            </code>
          </pre>
        </div>
