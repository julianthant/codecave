...
const scrollBarVariants = cva('flex transition-colors touch-none select-none', {
  variants: {
    orientation: {
  ...
  (
    ...
    return (
      <ScrollAreaPrimitive.ScrollAreaScrollbar
        ...
        {...props}
      >
        <ScrollAreaPrimitive.ScrollAreaThumb className="relative flex-1 hover:bg-foreground/30 bg-border rounded-full transition-colors" />
      </ScrollAreaPrimitive.ScrollAreaScrollbar>
    )
  }
)
